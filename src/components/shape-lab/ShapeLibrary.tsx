...
import { Shape } from "../../data/shapes/grammar";
...
export function ShapeLibrary({
  ...
  return (
    <aside className="shape-lab__library">
      <h2 className="shape-lab__library-title">Shape Library</h2>
      <button
        type="button"
        className="shape-lab__new-shape"
        onClick={onNew}
      ...
      {shapes.length === 0 ? (
        <div className="shape-lab__library-empty">
