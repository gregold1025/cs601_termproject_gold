...
// downward and the sky lerps from the biome's own color toward
...
// A fixed world altitude (px above the ground line) kept pristine: the biome
// sky shows untouched at rest and space only creeps in once you climb past it.
// This is a world-altitude design constant, independent of the (now variable)
// viewport height — it just happens to be 700px.
const SKY_GRACE = 700;
