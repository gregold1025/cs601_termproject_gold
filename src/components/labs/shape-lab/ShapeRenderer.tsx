...
//
// Wrapped in React.memo because the StickerLayer re-renders every
// camera frame; without memoization each placed sticker would re-run
// parseGrammar + computeRenderPolygons at 60Hz despite stable inputs.
...
function ShapeRendererImpl({ source, colorSeed, size }: ShapeRendererProps) {
...
export const ShapeRenderer = React.memo(ShapeRendererImpl);
