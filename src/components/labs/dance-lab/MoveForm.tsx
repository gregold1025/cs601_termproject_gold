    ...
    >
      <div className="lab__form-row">
        <label htmlFor="move-primary">
          Primary command
          {nameErrors.primary && (
            <span className="lab__label-error">Please select new name</span>
          )}
        </label>
        <input
          id="move-primary"
          type="text"
          className={nameErrors.primary ? "lab__input--error" : ""}
          value={primary}
      ...
      <div className="lab__form-row">
        <label htmlFor="move-secondary">
          ...
          {nameErrors.secondary && (
            <span className="lab__label-error">Please select new command</span>
          )}
        </label>
        <input
          id="move-secondary"
          type="text"
          className={nameErrors.secondary ? "lab__input--error" : ""}
          value={secondary}
